    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                Locality = identity.Claims.ToList().FirstOrDefault(c => c.Type.Equals(ClaimTypes.Locality)).Value
            };
        ...
        // POST: /Manage/Index
        [HttpPost]
        public async Task<ActionResult> Index(ManageMessageId? message, string Locality)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Ваш пароль изменен."
                : message == ManageMessageId.SetPasswordSuccess ? "Пароль задан."
            ...
            if (Locality == "ru-RU" | Locality == "uk-UA")
            {
                ...
                {
                    var identity = (ClaimsIdentity)User.Identity;
                    identity.RemoveClaim(identity.Claims.ToList().FirstOrDefault(c => c.Type.Equals(ClaimTypes.Locality)));
                    identity.AddClaim(new Claim(ClaimTypes.Locality, Locality));
